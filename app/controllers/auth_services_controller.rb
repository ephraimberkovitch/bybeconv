...
def create
  ...
  params[:auth_service] ? service_route = params[:auth_service] : service_route = 'No service recognized (invalid callback)'
  ...
  if omniauth and params[:auth_service]
    ...
    if service_route == 'facebook'
      ...
      omniauth['extra']['user_hash']['id'] ? @authhash[:uid] =  omniauth['extra']['user_hash']['id'].to_s : @authhash[:uid] = ''
      omniauth['provider'] ? @authhash[:provider] =  omniauth['provider'] : @authhash[:provider] = ''  
    elsif ['google', 'yahoo', 'twitter', 'benyehuda', 'openid'].index(service_route) != nil
      omniauth['user_info']['email'] ? @authhash[:email] =  omniauth['user_info']['email'] : @authhash[:email] = ''
      omniauth['user_info']['name'] ? @authhash[:name] =  omniauth['user_info']['name'] : @authhash[:name] = ''
    ...
    if @authhash[:uid] != '' and @authhash[:provider] != ''
      ...
      auth = AuthService.find_by_provider_and_uid(@authhash[:provider], @authhash[:uid])
...
def destroy
  ...
  if session[:auth_service_id] == @service.id
